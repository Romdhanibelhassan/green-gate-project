          ...
          <div class="tm-block-col tm-col-account-settings">
            <div class="tm-bg-primary-dark tm-block tm-block-settings">
              ...
              <form action="" class="tm-signup-form row">
                ...
                <div class="form-group col-lg-6">
                  ...
                  <input
                    ...
                    type="tel"
                    class="form-control validate"
                    value="(216)<?php echo $compte['telephone']; ?>"
                  />
                </div>
                <div class="form-group col-lg-6">
                ...
                <label class="tm-hide-sm">&nbsp;</label>
                  <button
                    type="submit"
                    class="btn btn-primary btn-block text-uppercase"
                    onclick="window.open('supprimercompte.php?IDcompte=<?php echo $compte['IDcompte']; ?>','_self')"
                  >
                    Delete Your Account
                  </button>
              ...
              <?php
				...
				?> 
          <button class="btn btn-primary btn-block text-uppercase" onclick="window.open('afficherListeComptes.php','_self')" >Retour </button>
            </div>
          </div>
        </div>
      </div>
