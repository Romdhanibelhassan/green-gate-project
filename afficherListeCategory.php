      ...
      <div class="row tm-content-row">
        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-products">
			...
			?>
                <tbody>
                  <tr>
                    ...
                    <td class="tm-product-name"><?php echo $category['id_category']; ?></td>
                    <td class="tm-product-name"><?php echo $category['types']; ?></td>
                    ...
                    <td>
                      <a href="supprimerCategory.php?id_category=<?php echo $category['id_category']; ?>" class="tm-product-delete-link">
            ...
            <!-- table container -->
            <a href="ajouterCategory.php" class="btn btn-primary btn-block text-uppercase" > ajouter </a>
          </div>
        </div>
